export default class UiElements {
    ...
    counter(string = "ready") {
        ...
        let counterHeight = innerHeight / this.rowCount
    ...
    inputText() {
        ...
        inputText.style.fontSize = innerHeight / this.rowCount * 0.5 + 'px'
        inputText.style.position = 'fixed';
        inputText.style.top = '16%'
        inputText.style.left = "30%"
    ...
    inputWindow() {
        ...
        inputWindow.style.fontSize = innerHeight / this.rowCount + 'px'
